...
Chef.create(name: "Thao Pham", specialty: food_speciality, price: (40..99).to_a.sample, profile_picture_url: "https://i.ibb.co/CMZY6NL/AG.jpg", bio: lorem )
Chef.create(name: "Adam Giegel", specialty: food_speciality, price: (40..99).to_a.sample, profile_picture_url: "https://i.ibb.co/4WXHFf5/TP.jpg", bio: lorem )
